...
export class AuthService {
  // auth.service.ts
  private rolUsuarioSubject = new BehaviorSubject<
    "admin" | "chofer" | null | undefined
  >(undefined);
  public rolUsuario$: Observable<"admin" | "chofer" | null | undefined> =
    this.rolUsuarioSubject.asObservable();

  get rolActual(): "admin" | "chofer" | null | undefined {
