...
export class GpsService {
  ...
  posicionActual$: Observable<PosicionGPS | null> = this._posicionActual.asObservable();
 ...
 async verificarPermisos(): Promise<{ otorgado: boolean; denegadoPermanente: boolean }> {
  try {
